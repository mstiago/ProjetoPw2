...
<body>
    ...
    <section class="sec-cabecalho" id="cabecalho">
        <div class="menu-home">
            <ul>
                ...
                <a class="btn-menu" href="#">Playlists</a>
                <a class="btn-menu" href="#">Sobre nós</a>
                <a class="btn-menu" href="#">Suporte</a>
    ...
    <section class="sec-recomendados">
        ...
        <div class="lista-recomendados">
            ...
            <div class="conteudo">
                <div class="foto-conteudo">
                    <a><img src="imagens/01.jpg"></a>
                </div>
                <h6 class="tit-conteudo">Battlefield 1</h6>
                <div class="icone-conteudo">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        x="0px" y="0px" viewBox="0 0 485.213 485.213" style="enable-background:new 0 0 485.213 485.213;"
                        xml:space="preserve">
        ...
        <div class="btn-lista">
            ...
            <a href="#">Veja a lista completa</a>
